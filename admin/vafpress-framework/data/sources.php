...
function vp_get_gwf_family()
{
	...
	$fonts = json_decode(elservice_filesystem('get_contents', dirname(__FILE__) . '/gwf.json'));
...
function vp_get_fontawesome_icons()
{
	...
	if( false === ( $icons  = get_transient( 'vp_fontawesome_icons' ) ) )
	{
		...
		$subject = elservice_filesystem('get_contents',VP_DIR . '/public/css/vendor/font-awesome.min.css');
