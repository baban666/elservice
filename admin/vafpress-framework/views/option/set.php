<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php _e('Save Changes', 'elservice'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php _e('Saving Now', 'elservice'); ?></p>
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf('This option panel is built using Vafpress Framework powered by Vafpress', VP_VERSION); ?></p>
		</div>
	</div>
</div>