...
<?php
    ...
    function rehub_get_social_links($content = null){
        ...
        <div class="social-icons">
            ...
            <?php if ( elservice_option('elservice_facebook') != '' ) :?>
                <a href="<?php echo elservice_option('elservice_facebook'); ?>" rel="nofollow" target="_blank"><i class="fab fa-facebook-f"></i></a>
            <?php endif;?>

            <?php if ( elservice_option('elservice_twitter') != '' ) :?>
                <a href="<?php echo elservice_option('elservice_twitter'); ?>" rel="nofollow" target="_blank"><i class="fab fa-twitter"></i></a>
            <?php endif;?>
            <?php if ( elservice_option('elservice_facebook') != '' ) :?>
                <a href="<?php echo elservice_option('elservice_facebook'); ?>" rel="nofollow" target="_blank"><i class="fab fa-facebook-f"></i></a>
            <?php endif;?>
...
function widget( $args, $instance ) {
	...
	if ( $title )
		echo '<div class="widget-title">' . '<h3>'. $title . '</h3>' . '</div>';
